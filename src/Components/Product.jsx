...
const Product = ({ img, name, price, aksiya, reting }) => {
  return (
    <div className="shadow-sm hover:shadow-md transition flex flex-col justify-between  ">
    
      <div className="relative ">
        <img src={img} alt={name} className="h-40 w-full object-contain bg-gray-100 p-4 " />
        {aksiya && (
